...
const PhotoApp = () => {
  const [currentPhase, setCurrentPhase] = useState('seleccionar');
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-gradient-to-br from-blue-800/50 to-slate-800/50 border-2 border-blue-600/50 rounded-2xl p-8 backdrop-blur-sm">
            <label className="block text-white text-lg font-bold mb-3">📍 Código de Suministro</label>
            <input
              type="text"
            ...
            />
            <p className="text-blue-200 text-sm mt-3">ℹ️ Este código agrupa todas tus fotos (antes, durante y después)</p>
          </div>
  ...
  // Función para renderizar pantallas de fase
